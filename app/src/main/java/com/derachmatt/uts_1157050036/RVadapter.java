...
import com.derachmatt.uts_1157050036.Detail;
import com.derachmatt.uts_1157050036.R;
...
public class RVadapter extends RecyclerView.Adapter<RVadapter.ViewHolder>{
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_pertandingan, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, final int i) {
        ...
        viewHolder.parentLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(mContext, "Hasil Pertandingan Persib Bandung", Toast.LENGTH_SHORT).show();
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            t1 = itemView.findViewById(R.id.club1);
            t2 = itemView.findViewById(R.id.club2);
